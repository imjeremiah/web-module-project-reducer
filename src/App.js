...
import { applyNumber, changeOperation, clearDisplay, addMemory, recallMemory, clearMemory } from "./actions/index";
  ...
  return (
    <div className="App">
      <nav className="navbar navbar-dark bg-dark">
        <a className="navbar-brand" href="#"><img width="40px" src="./Lambda-Logo-Red.png" alt="Lambda School logo"/> Lambda Reducer Challenge</a>
      </nav>
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              ...
              <CalcButton onClick={() => dispatch(recallMemory())} value={"MR"}/>
